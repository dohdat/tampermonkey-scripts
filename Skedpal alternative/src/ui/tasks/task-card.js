...
import { buildDetailItemElement, buildTaskMeta } from "./task-card-detail-meta.js";
...
function maybeAppendTaskDetails(
  taskCard,
  task,
  timeMapOptions,
  repeatSummary,
  ...
  if (typeof cleanup === "function" && !disableInteractions) {
...
export function renderTaskCard(task, context) {
  ...
  const disableInteractions = Boolean(context?.disableTaskDetailInteractions);
